...
class Entry2ViewController: UIViewController, UIImagePickerControllerDelegate, UINavigationControllerDelegate {
    ...
    private func performSave() {
        ...
        let newCount: Int
                ...
                showAlert(title: "Success", message: "Job Post Added!") { [weak self] in
                    ...
                    if let ResourceTableViewCell = self?.navigationController?.viewControllers.first as? ResourceTableViewCell {
                    DispatchQueue.main.async {
                        ResourceTableViewCell.updateTasks()
                    }
                }
...
extension Entry2ViewController: UITextFieldDelegate {
...
extension Entry2ViewController: UITextViewDelegate {
