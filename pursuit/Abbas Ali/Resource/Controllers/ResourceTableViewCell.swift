...
class ResourceTableViewCell: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    override func viewDidLoad() {
        ...
        tableView.register(Job2TableViewCell.self, forCellReuseIdentifier: Job2TableViewCell.identifier)
    ...
    @IBAction func didTapAdd() {
        ...
        let vc = storyboard?.instantiateViewController(identifier: "entry2") as! Entry2ViewController
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        guard let cell = tableView.dequeueReusableCell(withIdentifier: Job2TableViewCell.identifier, for: indexPath) as? Job2TableViewCell else {
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        let job = jobs[indexPath.row]
        let vc = storyboard?.instantiateViewController(identifier: "task2") as! Task2ViewController
        vc.hidesBottomBarWhenPushed = true
        vc.title = job.title
        vc.task = job.title
