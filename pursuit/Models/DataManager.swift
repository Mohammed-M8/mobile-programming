...
class DataManager{
    ...
    func addData(){
        ...
        let job2 = Job(jobTitle: "Senior Developer", companyName: "Viva", extraComment: "iohafih", Salary: 30.00, type: "back end", Location: "muharraq", Details: "ijahiuahduia", Requirements: "aniownfinawfo", dateCreated: Date(),imgJob:UIImage(named: "imagebetelco")!, industry: "Software")
        
        let job3 = Job(jobTitle: "Developer", companyName: "Pursuit", extraComment: "oiahfoihwaifoabfw", Salary: 20.00, type: "front end", Location: "muharraq", Details: "ijahiuahduia", Requirements: "aniownfinawfo", dateCreated: Date(),imgJob:UIImage(named: "imagebetelco")!, industry: "Web")
        
        DataManager.Instance.addJobs(job1)
        DataManager.Instance.addJobs(job2)
        DataManager.Instance.addJobs(job3)
        
        let resource1 = Resources(ResourceTitle: "Xcode For Noobs lol", CompanyName: "Xcode", ExtraComment: "you will learn here", Hours: 20, ResourceType: "Easy", Industry: "Software", Details: "aknfioanfpanfaofnapofnapofnaopf", Summary: "ianfioabwfi;bafobwfbafiobiwbfiawbf", dateCreated: Date(),imgResource: UIImage(named: "imagebetelco")!,content: "ABCDEFGHIJKLMNOPQRSTUVWXYZ")
